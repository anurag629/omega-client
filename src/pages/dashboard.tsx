...
const Dashboard: React.FC = () => {
  ...
  // Effect to ensure sidebar is open on large screens
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth >= 1024) {
        setSidebarOpen(true);
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="fixed top-20 left-4 z-50 lg:hidden">
          <button
            ...
            className="p-2 rounded-md bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 shadow-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        ...
        {/* Sidebar */}
        <motion.aside 
          className="fixed lg:fixed top-16 h-[calc(100vh-4rem)] w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-lg z-40 lg:shadow-none overflow-hidden"
          initial={false}
          animate={{ 
            x: sidebarOpen ? 0 : -320,
            width: 320,
        ...
        >
          <div className="flex flex-col h-full">
            ...
            {/* Sidebar Settings */}
            <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/90">
        ...
        {/* Main content area */}
        <main className={`flex-1 flex flex-col relative ${sidebarOpen ? 'lg:ml-80' : 'ml-0'} transition-all duration-200`}>
          {/* Chat content area - scrollable */}
          <div className="flex-1 overflow-y-auto pb-36 pt-16 lg:pt-0 px-4 bg-gray-50 dark:bg-gray-900">
            {/* Empty state */}
          ...
          <motion.div 
            className="fixed bottom-0 left-0 right-0 lg:left-80 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-lg dark:shadow-gray-900/50 z-10"

...
module.exports = {
    ...
    extend: {
      colors: {
        primary: {
          ...
          300: '#93C5FD',
          400: '#60A5FA',
          500: '#4285F4', // Main primary color - Google Blue
          600: '#2563EB',
          700: '#1D4ED8',
          800: '#1E40AF',
          900: '#1E3A8A',
  ...
  plugins: [
    // Safe import of the forms plugin
    function () {
      try {
        return require('@tailwindcss/forms');
      } catch (e) {
        console.warn('Warning: @tailwindcss/forms plugin is not installed. Form styling may be affected.');
        return {};
      }
    }(),
  ],
